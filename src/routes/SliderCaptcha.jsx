...
const SliderCaptcha = () => {
  ...
  return (
    <div className="flex flex-col items-center gap-8 p-5">
      ...
      <p className="text-secondary text-center mb-4">Surprisingly good CAPTCHA experiments that are fun to solve.</p>

      <div className="relative w-[300px] h-[300px] bg-tertiary rounded-full p-2 shadow-card">
      ...
      <div className="w-full max-w-[400px] text-center">
        <p className="text-secondary mb-3">Drag the slider to fit the puzzle</p>
        ...
        <div className="flex justify-center items-center gap-4 mt-6">
          {isSolved ? (
            <div className="flex items-center gap-2">
              <span className="green-text-gradient font-medium text-lg">Verified!</span>
              <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-[#00cea8]" viewBox="0 0 20 20" fill="currentColor">
                <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
              </svg>
            </div>
          ) : (
            <span className="text-secondary">Slide to verify</span>
          )}
          <button
